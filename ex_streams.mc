...
void subr (int32_t In[], int64_t Out[], int num, int *nret, int64_t *time, int mapnum) {
        ...
        #pragma src section
	{
        ...
        for (i=0; i<num; i++) {
           ...
           iput = 0;
           if (v0>256 & v0<10512)  iput = 1;

           put_stream_64 (&SF0, v64_0, iput);
        ...
        #pragma src section
	{
        stream_merge_2_64_term (&SF0, &SF1, &SM);
	}
    ...
    *time = t1 - t0;
    ...
    #pragma src section
	{
	streamed_dma_cpu_64 (&SOut, STREAM_TO_PORT, Out, *nret*2*sizeof(int64_t));
	}
	}
